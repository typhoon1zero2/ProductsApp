      ...
      <DefaultLayout>
        ...
        <div class="bg-primary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
          ...
          <div class="row">
            <div class="col-sm">
            <div class="my-3 py-3">
              <h2 class="display-5">How I Developed my first full-stack CRUD Project!</h2>
              <p class="lead"> Learning a new Technology is not only watching tutorials and
                ...
                and read documentations Design your own Schemas,Write custom
                Apis,etc... In this Apis I will walk through my step by step
                process in developing my first CRUD project.</p>
              </div>
            </div>
            <div class="col-sm">
            <div class="my-3 py-3">
              ...
              <p class="lead">
                ...
                architecture and done a initial design of Models , Controllers
                and even Routes and middlewares for backend. Below is the
                screenshot of my initial backend design.
            ...
            <div class="my-3 py-3">
              ...
              <p class="lead">
                I started with writing my schemas for database I used the Mongo
                and I had 2 MODELS in my application. After that I started an
                EXPRESS SERVER in localhost and connected my Db with it and once
                my app is up and running I started with my backend controllers
                and wrote APIs for my application corresponding to the routes
                that I designed initially.
            ...
            <div class="my-3 py-3">
              ...
              <p class="lead">
                ...
                By referring my figma design I stated to design my frontend
                using REACT (jsx).For a fresher like me it is not a easy task to
                design the frontend.I used my local server for my backend and
                used my custom Apis for the frontend and for state management I
                used REDUX for checking the Auth status of a user.
